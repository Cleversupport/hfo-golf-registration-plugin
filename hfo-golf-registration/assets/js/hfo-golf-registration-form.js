(function () {
	...
	function getVisibleStepKeys(registrationType) {
		...
		if (registrationType !== 'sponsor_only' && registrationType !== 'additional_guests') {
	...
	function validateAdditionalGuestsStep(form) {
		...
		var totalGuests = getNumericFieldValue(form, 'additional_lunch_count') + getNumericFieldValue(form, 'additional_dinner_count');
	...
	function calculateReview(form) {
		...
		var additionalLunchGuests = getNumericFieldValue(form, 'additional_lunch_count');
		var additionalDinnerGuests = getNumericFieldValue(form, 'additional_dinner_count');
		...
		lunchQty = additionalLunchGuests;
		dinnerQty = additionalDinnerGuests;
		...
		setSummary(form, 'additional_lunch_guests', String(additionalLunchGuests));
		setSummary(form, 'additional_dinner_guests', String(additionalDinnerGuests));
	...
	function normalizeHiddenParticipantsBeforeSubmit(form) {
		...
		if (registrationType === 'additional_guests') {
			var sponsorLevel = getField(form, 'sponsorship_level');
			var teeSponsor = getField(form, 'tee_sponsor_selected');
