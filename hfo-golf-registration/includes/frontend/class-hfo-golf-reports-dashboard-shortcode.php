...
class HFO_Golf_Reports_Dashboard_Shortcode {
	...
	public function render_shortcode() {
		...
		<div class="hfo-golf-reports-dashboard">
			...
			<div class="hfo-golf-reports-dashboard__sections">
				...
				<?php $this->render_section( __( 'Registration Type Breakdown', 'hfo-golf-registration' ), array( 'team' => __( 'Team Registration', 'hfo-golf-registration' ), 'individual' => __( 'Individual Player Registration', 'hfo-golf-registration' ), 'additional_guests' => __( 'Guest Meal Registration', 'hfo-golf-registration' ), 'sponsor_only' => __( 'Sponsor Registration', 'hfo-golf-registration' ) ), $report ); ?>
	...
	private function render_cards( $report ) {
		$items = array( 'total' => __( 'Total Registrations', 'hfo-golf-registration' ), 'paid' => __( 'Total Paid', 'hfo-golf-registration' ), 'team' => __( 'Team Registration', 'hfo-golf-registration' ), 'individual' => __( 'Individual Player Registration', 'hfo-golf-registration' ), 'additional_guests' => __( 'Guest Meal Registration', 'hfo-golf-registration' ), 'sponsor_only' => __( 'Sponsor Registration', 'hfo-golf-registration' ), 'players' => __( 'Players', 'hfo-golf-registration' ), 'lunch' => __( 'Lunch Guests', 'hfo-golf-registration' ), 'dinner' => __( 'Dinner Guests', 'hfo-golf-registration' ), 'sponsors' => __( 'Sponsors', 'hfo-golf-registration' ) );
