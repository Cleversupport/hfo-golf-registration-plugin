...
class HFO_Golf_Registration_Lookup_Shortcode {
	...
	public function build_registration_lookup_row( $registration_id ) {
		...
		return array(
			...
			'type'               => $this->label( $type, array( 'team' => 'Team Registration', 'individual' => 'Individual Player Registration', 'additional_guests' => 'Guest Meal Registration', 'sponsor_only' => 'Sponsor Registration' ) ),
	...
	private function render_report_summary( $summary ) {
		$items = array( 'total' => __( 'Total Registrations', 'hfo-golf-registration' ), 'paid' => __( 'Total Paid', 'hfo-golf-registration' ), 'team' => __( 'Team Registration', 'hfo-golf-registration' ), 'individual' => __( 'Individual Player Registration', 'hfo-golf-registration' ), 'additional_guests' => __( 'Guest Meal Registration', 'hfo-golf-registration' ), 'sponsor_only' => __( 'Sponsor Registration', 'hfo-golf-registration' ), 'platinum' => __( 'Platinum Sponsors', 'hfo-golf-registration' ), 'gold' => __( 'Gold Sponsors', 'hfo-golf-registration' ), 'silver' => __( 'Silver Sponsors', 'hfo-golf-registration' ), 'tee' => __( 'Tee Sponsors', 'hfo-golf-registration' ), 'lunch' => __( 'Lunch Guests', 'hfo-golf-registration' ), 'dinner' => __( 'Dinner Guests', 'hfo-golf-registration' ) );
	...
	private function render_search_form( $filters ) {
		...
		<form class="hfo-golf-registration-lookup-form" method="get">
			...
			<?php $this->render_select( 'hfo_lookup_type', __( 'Registration Type', 'hfo-golf-registration' ), $filters['registration_type'], array( '' => __( 'All Types', 'hfo-golf-registration' ), 'team' => __( 'Team Registration', 'hfo-golf-registration' ), 'individual' => __( 'Individual Player Registration', 'hfo-golf-registration' ), 'additional_guests' => __( 'Guest Meal Registration', 'hfo-golf-registration' ), 'sponsor_only' => __( 'Sponsor Registration', 'hfo-golf-registration' ) ) ); ?>
